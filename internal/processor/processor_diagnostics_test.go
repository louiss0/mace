...
var _ = Describe("Diagnostic fixtures", func() {
	DescribeTable("triggers the documented error",
		...
		Entry("schema missing terminator", "schema-missing-terminator", "expected ';' after schema declaration"),
		...
		Entry("invalid choice member", "choice-invalid-member", "use fusion to merge choice types"),
		...
		Entry("import missing terminator", "import-missing-terminator", "expected ';' after import declaration"),
		...
		Entry("invalid output documentation", "output-inline-doc-requires-directive-list", "description directive must evaluate to a string"),
