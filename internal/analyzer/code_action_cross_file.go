...
func crossFileActionAnalysis(text string, documentPath string) ([]protocol.Diagnostic, []analysisCodeActionCandidate) {
	specifications := []crossFileActionSpec{
		...
		{"[output = 'data'] {}", "mace.workspace.stop-export", "Stop exposing a declaration and remove unused imports", protocol.CodeActionKindRefactorRewrite, "", "shared.mace", "[output = 'data'] {}"},
